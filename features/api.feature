Feature: Testing the API
  ...
  Scenario: Test for API tests
    Given a file named "features/api.feature" with:
      """
      Feature: Testing
        ...
        Scenario: Test authentication details (POST)
          ...
          And the "headers.authorization[0]" property equals "usernameone:apikeyone"
        ...
        Scenario: Test authentication details (GET)
         ...
         Scenario: Simple test that show most options
          ...
          Given that the properties are imported from the JSON file "testdata.json"
          When I make a "GET" request to "/oindex.php"
          Then echo last response
          Then wait "1" second
          Then the response status code should be "200"
          And the response is not empty
        ...
        Scenario: Test Raw data
          ...
          '''
          When I make a "POST" request to "/oindex.php"
          Then the response status code should be "200"
          And the response is not empty
          And the "success" property equals "true"
        ...
        Scenario: Test RAW input file data
          ...
          Given that the request body is imported from the file "testdata.json"
          When I make a "POST" request to "/oindex.php"
          Then the response status code should be "200"
          And the response is not empty
          And the "success" property equals "true"
        ...
        Scenario: Test empty response from server
          When I make a "GET" request to "/empty"
          Then the response status code should be "204"
          And the response is empty
      """
    When I run "behat features/api.feature"
