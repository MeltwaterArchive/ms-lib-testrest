...
class FeatureContext implements SnippetAcceptingContext
{
    ...
    {
        if (is_dir($dir = sys_get_temp_dir() . DIRECTORY_SEPARATOR . 'behat-test-rest')) {
    ...
    {
        $dir = sys_get_temp_dir() . DIRECTORY_SEPARATOR . 'behat-test-rest' . DIRECTORY_SEPARATOR .
    ...
    public function itShouldFail($success)
    {
        if ('fail' === $success) {
            ...
            \Webmozart\Assert\Assert::notEq(0, $this->getExitCode());
        } else {
            if (0 !== $this->getExitCode()) {
                echo 'Actual output:' . PHP_EOL . PHP_EOL . $this->getOutput();
            }

            \Webmozart\Assert\Assert::eq(0, $this->getExitCode());
        }
    }
